...
--1) INSERT INTO 테이블AUD VALUES(데이터,데이터,...);
--테이블에 모든 컬럼에 대한 값을 INSERT 할 때 사용
-- INSERT 하고자 하는 컬럼이 모든 컬림인 경우 컬럼명 생략 가능
...
-- DEPARTMENT2 테이블에서 DEPT_ID가 D9인 부서를 전략기획팀으로 수정
...
UPDATE DEPARTMENT2
SET
   DEPT_ID = 'D0', DEPT_TITLE = '회계관리팀' WHERE DEPT_ID = 'D2';
   SELECT * FROM DEPARTMENT2;
