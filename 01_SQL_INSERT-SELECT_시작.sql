...
INSERT INTO kh_cafe (c_id,c_name,c_address,c_phone,c_time)VALUES (2,'빠나프레쏘','서울시 강남구 역삼동','02-5555-5555','영업시간 12:00 ~ 14:00');

INSERT INTO kh_cafe (c_id,c_name,c_address,c_phone,c_time)VALUES (3,'컴포즈커피','경기도 화남시 화남구','031-3232-3333','영업시간 10:00 ~ 17:00');

INSERT INTO kh_cafe (c_id,c_name,c_address,c_phone,c_time)VALUES (4,'할리스커피','인천시 남동구 남동동','032-8888-8888','영업시간 10:00 ~ 17:00');

INSERT INTO kh_cafe (c_id,c_name,c_address,c_time)VALUES(5,'커피빈','역삼동','영업시간 평일 10:00 ~ 13:00');

INSERT INTO kh_cafe (c_id,c_name,c_address,c_phone,c_time)VALUES(6,'스타벅스','서울시 종로구 관철동','02-1111-2222','영업시간 평일 08:00 ~ 22:00');

INSERT INTO kh_cafe (c_id,c_name,c_address,c_phone,c_time)VALUES(7,'탐엔탐스','서울시 동대문구 장안동','02-5555-6666','영업시간 평일 10:00 ~ 20:00');

INSERT INTO kh_cafe (c_id,c_name,c_address,c_phone,c_time)VALUES(8,'이디야커피','서울시 송파구 잠실동','02-1234-6789','영업시간 평일 09:00 ~ 21:00');





-- 3 컴포즈커피 경기도 화남시 화남구 031-3232-3333 영업시간 평일 15:00 ~ 18:00
...
-- 7 탐엔탐스 서울시 동대문구 장안동 02-5555-6666 영업시간 평일 10:00 ~ 20:00
...
SELECT : 저장된 데이터를 볼 때 사용
 ...
 SELECT 어떤 칼럼을 볼지 선택 FROM 어느 테이블에서 가져올지 테이블명 작성
