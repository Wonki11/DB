...
--2. EMPLOYEE 테이블에서 모든 직원의 급여를 내림차순 정렬 조회 모두보기
...
--4. 아이디 이름 급여 조회는 급여는 AS 월급 월급으로 내림차순
SELECT EMP_ID,EMP_NAME,SALARY AS "월급" FROM EMPLOYEE 
ORDER BY "월급" DESC;

--5. EMPLOYEE 테이블에서 모든 직원의 보너스를 AS 보너스로 표기 보너스 내림차순 정렬 SALARY AS 월급 월급 오름차순 정렬
SELECT EMP_NAME,BONUS AS "보너스",SALARY AS "월급" FROM EMPLOYEE
