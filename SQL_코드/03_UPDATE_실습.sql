...
UPDATE EMPLOYEE3 SET DEPT_CODE = 'D5' , JOB_CODE = 'J5' WHERE JOB_CODE = 'J3';
ROLLBACK;
--송은희 직원 이름과 이메일 변경 송은휘 SONGSONG@or.kr
UPDATE EMPLOYEE3 SET EMP_NAME = '송은휘', EMAIL = 'SONGSONG@or.kr' WHERE EMP_NAME = '송은희';
ROLLBACK;
SELECT * FROM EMPLOYEE3;
--차태연 직원의 이름과 급여변경 차태형 8000000 , EMPLOYEE3 해당하는 모든 직원의 이메일 도메인과 부서코드 D4로 변경
UPDATE EMPLOYEE3 SET EMP_NAME = '차태형' , SALARY = 8000000 WHERE EMP_NAME = '차태연';
UPDATE EMPLOYEE3 SET EMAIL = REPLACE('EMAIL','or.kr','KR.KR'),DEPT_CODE = 'D4';
