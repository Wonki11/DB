...
JOIN JOB ON (DEPT_CODE = JOB_CODE) ,
JOIN LOCATION (DEPT_CODE = LOCAL_CODE);
--ORACLE
SELECT EMP_ID , EMP_NAME, JOB_NAME, DEPT_TITLE, LOCAL_NAME, SALARY
FROM EMPLOYEE E , DEPARTMENT D , JOB J , LOCATION L 
WHERE E.DEPT_CODE = D.DEPT_ID AND E.JOB_CODE = J.JOB_CODE AND D.LOCATION_ID = L.LOCATION_CODE AND 
