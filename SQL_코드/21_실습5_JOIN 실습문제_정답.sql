...
JOIN LOCATION L ON L.LOCAL_CODE = LOCATION_ID 
WHERE BONUS IS NOT NULL;

--5. 부서가 있는 사원의 사원명, 직급명, 부서명, 지역명 조회
SELECT EMP_NAME,DEPT_CODE,JOB_NAME,LOCAL_NAME
FROM EMPLOYEE 
...
--연봉에 보너스포인트를 적용하시오.
SELECT E.EMP_NAME, J.JOB_NAME,E.SALARY,(E.SALARY + NVL(E.BONUS,0))AS "연봉" --연봉 나타내는데 NVL 이용해서 보너스가 없으면 0 
FROM EMPLOYEE E 
...
-- 직원의 급여가 최소 급여보다 큰 직원들 만 선택할 수 잇도록 조건 설정
...
JOIN EMPLOYEE E2 ON E1.DEPT_CODE = E2.DEPT_CODE 
    AND E1.EMP_ID != E2.EMP_ID; -- 내 부서에서 나와 같이 근무하는 사람들을 봐야하기 때문에 내 코드는 보여주지 않음
